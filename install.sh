#!/bin/bash
# This is the official install script for Claude Code CLI as of 10 Feb 2026
# The actual container doesn't necessarily use this version (it pulls the latest)
# This is just a copy for reference.
